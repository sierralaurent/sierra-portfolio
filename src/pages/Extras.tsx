...
export default function Extras() {
  return (
    ...
    <NavBar /> 
    <main className={`flex min-h-screen flex-col gap-5 pt-32 items-center text-black mobile:align-center`}>
      ...
      <div className={' flex flex-col m-20 mx-48 max-w-5xl p-12 gap-10'}>
        <FadeIn index={1}>
          ...
          <div className={'flex flex-row gap-10 pt-10 tablet:flex-col'}>
              <PhotoFlip 
