    ...
    <main className={`flex min-h-screen flex-col items-center text-black p-48`}>
      ...
      <div className={'py-8 text-xl'}>
        ...
        <Image
          ...
          src='/images/PicTok/Mock-Up PicTok-Long.png'
          width={2000}
          height={400}
        ...
        <div className={'flex flex-col gap-8'}>
            ...
            <div className={'flex -flex-row justify-between py-8'}>
                <Image
                    className={'py-3'}
                    src='/images/PicTok/PicTok Screens/Gesture03.png'
                    width={200}
                    height={100}
                ...
                <Image
                    className={'py-3'}
                    src='/images/PicTok/PicTok Screens/Gesture04.png'
                    width={200}
                    height={100}
                ...
                <Image
                    className={'py-3'}
                    src='/images/PicTok/PicTok Screens/Gesture05.png'
                    width={200}
                    height={100}
