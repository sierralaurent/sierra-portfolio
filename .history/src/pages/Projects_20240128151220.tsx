...
export default function Projects() {
  return (
    ...
    <main className={`flex min-h-screen flex-col items-center p-8 text-black`}>
      ...
      <div className={'flex flex-row justify-center items-center gap-16 tablet:flex-col m-16'}>
        <div className={'flex flex-col gap-8'}>
          <h1 className={'text-3xl font-bold'}>TuneZilla GIF's for Social media</h1>
          <p className={'text-xl'}>TuneZilla wanted a little something extra to social media posts and stories, so I made some GIFs that could be used as stickers for that little extra branding.</p>
        </div>
        <TzSlideshow />
      </div>
