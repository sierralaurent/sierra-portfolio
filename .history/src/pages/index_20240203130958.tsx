...
export default function Home() {
  ...
  return (
    ...
    <Card key={i} index={i} className={'tablet:flex-col tablet:max-w-sm max-w-4xl bg-Sage text-white flex flex-row m-10 gap-8 tablet:gap-4 items-center rounded-2xl'}>
      <Image
