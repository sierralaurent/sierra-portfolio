...
export default function Home() {
  return (
    ...
    <div className={' tablet:flex-col max-w-4xl bg-Sage text-white flex flex-row m-10 gap-8 items-center rounded-2xl'}>
      <Image
    ...
    <div className={'tablet:flex-col tablet:max-w-2xl max-w-4xl text-white bg-Emerald text-right flex flex-row gap-8 m-10 items-center rounded-2xl'}>
        <div className={'flex flex-col gap-10 p-10'}>
        ...
        <Image
        className={'rounded-r-lg tablet:rounded-b-lg'}
