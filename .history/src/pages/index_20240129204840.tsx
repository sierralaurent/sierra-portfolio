...
export default function Home() {
  return (
    ...
    <div className={'bg-Sage text-white flex flex-row gap-8 items-center'}>
      <Image
        className={''}
        ...
        />
        <div className={'flex flex-col gap-10'}>
          <h1 className={'text-3xl'}>PicTok</h1>
          ...
          <Link href="/About"><button className={'bg-Emerald text-white p-3 text-2xl rounded-lg hover:bg-Emerald hover:scale-110 transition-transform'}>See More</button></Link>
        </div>
    </div>
    </main>
    <Footer />
