      ...
      <div className={'py-8 text-xl'}>
        ...
        <div className={'flex flex-col gap-8'}>
            ...
            <div className={'flex -flex-row justify-between py-8'}>
                <Image
                    className={'py-3'}
                    src='/images/NewHabits/NewHabits-Screens/Get started.png'
                    width={200}
                    height={100}
                ...
                <Image
                    className={'py-3'}
                    src='/images/NewHabits/NewHabits-Screens/Resources1.png'
                    width={200}
                    height={100}
            ...
            <div className={'flex flex-col gap-5 py-5'}>
                    ...
                    <Image
                        className={'py-3'}
                        src='/images/NewHabits/Newhabits-UserTest2.png'
                        width={1000}
                        height={200}
                        alt='User Persona'
                    />
                ...
                <div className={'flex flex-col gap-5 py-5'}>
                    ...
                    <Image
                        ...
                        src='/images/NewHabits/Newhabits-UserTest3.png'
                        width={700}
                        height={200}
                        alt='User Persona'
                    />
            ...
            <div className={'flex flex-col'}>
                ...
                <div className={'flex flex-row items-center justify-center py-10 tablet:flex-col'}>
                    ...
                    <Image
                        className={'p-3'}
                        src='/images/NewHabits/NewHabits-Screens/Humphrey Intro.png'
                        width={150}
                        height={150}
                        alt='Gesture Screen03'
                        />
                    ...
                    <Image
                        className={'p-3'}
                        src='/images/NewHabits/NewHabits-Screens/Game Tutorial.png'
                        width={150}
                        height={100}
                        alt='gesture Screen05'
                        />
                        ...
                        <div className={'flex flex-row justify-between'}>
                            <Image
                                className={'p-3'}
                                src='/images/NewHabits/NewHabits-Screens/Info Page.png'
                                width={150}
                                height={100}
                                alt='Gesture Screen03'
                                />
                            <Image
                                className={'p-3'}
                                src='/images/NewHabits/NewHabits-Screens/Statistics.png'
                                width={150}
                                height={100}
                                alt='Gesture Screen04'
                                />
