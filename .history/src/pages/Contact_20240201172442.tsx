...
export default function Contact() {
  return (
    ...
    <NavBar /> 
    <main className={`flex min-h-screen flex-col text-center items-center m-32 text-black `}>
      ...
      <div className={'flex tablet:flex-col min-w-full flex-row m-24 p-10 justify-between'}>
