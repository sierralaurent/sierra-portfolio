  ...
  return (
    ...
    <main className={`flex min-h-screen flex-col items-center text-black p-48`}>
      ...
      <div className={'py-8 text-xl'}>
        ...
        <div className={'flex flex-col items-center gap-15 my-28 text-center'}>
            ...
            <Link href="/Projects"><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald hover:scale-110 transition-transform'}>Next Project</button></Link>
            </div>
        </div>
