      ...
      <div className={'py-8 text-xl'}>
        ...
        <div className={'flex flex-col gap-8'}>
            ...
            <div className={'flex flex-col gap-5 py-5'}>
                ...
                <div className={'flex flex-col gap-5 py-5'}>
                    <h1 className={'text-3xl'}>2. Creating simple, yet effective navigation</h1>
        ...
        <div className={'flex flex-col items-center gap-10 m-28'}>
            <h1 className={'text-5xl'}>Hope you enjoyed PicTok!</h1>
            <h2 className={'text-3xl'}>Go back to see the rest of my projects</h2>
            <Link href="/Projects"><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald'}>Projects</button></Link>
        </div>
    </main>
    <Footer />
    </>
