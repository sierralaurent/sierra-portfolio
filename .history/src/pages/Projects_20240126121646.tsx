...
import Slideshow from '@/components/canSlideshow'
    ...
    <main className={`flex min-h-screen flex-col items-center p-8 text-black`}>
      ...
      <div className={'flex flex-row items-center gap-20 p-60 py-20 tablet:flex-col tablet:p-48 tablet:gap-10 tablet:py-10'}>
        <div className={'flex flex-col gap-10 text-right'}>
          ...
          quiz within the app that asks the users a set of questions outlining the biggest and most noticeable effects of substance misuse disorder.</h3>
      ...
      <h1 className={'font-bold text-5xl m-16 text-left'}>Design/Graphic Projects</h1>
      <div className={'flex flex-row justify-center items-center gap-16 tablet:flex-col'}>
        <Slideshow />
        <div className={'flex flex-col gap-8'}>
          <h1 className={'text-3xl font-bold'}>Hops & Pigs Brewery Can Mockup</h1>
          <p>A fictional brewery made by myself, to display the design and photoshop skills learned.</p>
        </div>
      </div>
