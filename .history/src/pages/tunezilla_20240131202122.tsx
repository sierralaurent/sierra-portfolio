...
export default function TuneZilla() {
  return (
    ...
    <main className={`flex min-h-screen flex-col items-center text-black`}>
        ...
        />
        <Image
            className={'animate-slideLeftToRight w-full h-auto animate-duration-5000 animate-iteration-count-infinite'}
        ...
        <div className={'flex flex-col items-center gap-10 m-16 mb-20 text-center'}>
            ...
            <div className={'flex flex-row gap-12 items-center'}>
                ...
                <Link href="/TZ"><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald hover:scale-110 transition-transform'}>Next Project</button></Link>
            </div>
      </div>
    </main>
    <Footer />
