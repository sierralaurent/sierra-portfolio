...
export default function Home() {
  return (
    ...
    <div className={'bg-Sage text-white flex flex-row justify-between items-center'}>
      <Image
        className={''}
        ...
        <div>
          ...
          <Link href="/About"><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald hover:scale-110 transition-transform'}>See More</button></Link>
        </div>
    </div>
    </main>
    <Footer />
