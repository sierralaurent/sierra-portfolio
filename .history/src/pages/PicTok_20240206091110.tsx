    ...
    <Scroll />
        ...
        <div className={'flex flex-col max-w-6xl p-12 gap-10 items-center m-20 mx-48'}>
            <div className={'flex flex-col gap-5 text-center items-center'}>
                ...
                <Link href="https://pictok.vercel.app/" rel="noopener noreferrer" target="_blank"><Button backgroundColor='Sage'>View App</Button></Link>
            </div>
        ...
        <div className={'flex flex-col w-full items-start gap-6'}>
            <h1 className={'text-3xl font-semibold'}>Marketing Extras</h1>
        </div>
        <div className={'tablet:flex-col max-w-4xl min-w-2xl tablet:max-w-sm bg-Sage text-white flex flex-row tablet:gap-4 m-10 mx-20 items-center rounded-2xl'}>
            <Image
        ...
        <div className={'tablet:flex-col max-w-4xl min-w-2xl tablet:max-w-sm bg-Emerald text-white flex flex-row tablet:gap-4 m-10 mx-20 items-center rounded-2xl'}>
            <div className={'flex flex-col gap-10 p-10 tablet:p-5'}>
                <h1 className={'text-3xl font-semibold'}>Brochures</h1>
            </div>
            <Image
        ...
        <div className={'tablet:flex-col max-w-4xl min-w-2xl tablet:max-w-sm bg-Sage text-white flex flex-row tablet:gap-4 m-10 mx-20 items-center rounded-2xl'}>
            <Image
                className={'desktop:rounded-l-2xl tablet:rounded-t-2xl'}
                src='/images/PicTok/tee-shirts.png'
                width={400}
                height={400}
                alt='pictok business cards'
            />
            <div className={'flex flex-col gap-10 p-10 tablet:p-5'}>
                <h1 className={'text-3xl font-semibold'}>Tee-Shirts</h1>
        ...
        <div className={'flex flex-col items-center gap-10 mb-28 text-center'}>
            ...
            <div className={'flex flex-row gap-12 items-center'}>
                ...
                <Link href="/NewHabits"><Button backgroundColor='Sage'>Next Project</Button></Link>
            </div>
      </div>
    </main>
    <Footer />
