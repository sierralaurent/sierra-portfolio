...
export default function Extras() {
  return (
    ...
    <NavBar /> 
    <main className={`flex min-h-screen flex-col gap-10 pt-32 items-center text-black`}>
      <h1 className={'text-5xl font-bold'}>See my Designs here!</h1>
      <h2 className={'text-3xl font-semibold'}>Click the cards for more info</h2>
