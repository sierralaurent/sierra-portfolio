    ...
    <main className={`flex min-h-screen flex-col items-center text-black`}>
        ...
        <div className={'flex flex-col max-w-6xl p-12 gap-10 items-center m-20 mx-48 tablet:mx-6 tablet-m-5'}>
            <div className={'flex flex-col gap-5 items-center text-center'}>
                ...
                <Link href="https://newhabits.vercel.app/" rel="noopener noreferrer" target="_blank"><Button backgroundColor="Sage">View App</Button></Link>
            </div>
        ...
        <div className={'flex flex-col items-center gap-10 mb-28 text-center tablet:mx-6'}>
            ...
            <div className={'flex flex-row gap-12 items-center'}>
                ...
                <Link href="/MAS"><Button backgroundColor='Sage'>Next Project</Button></Link>
            </div>
      </div>
    </main>
    <Footer />
