...
export default function Home() {
  return (
    ...
    <NavBar /> 
    <Notification />
    <main className={`flex min-h-screen flex-col items-center m-38 text-black gap-40`}>
    ...
    <div className={'bg-Sage text-white flex flex-row gap-8 m-20 items-center rounded-lg'}>
      <Image
