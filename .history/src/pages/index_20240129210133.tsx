...
export default function Home() {
  return (
    ...
    <div className={'text-black flex flex-row gap-8 m -10 mx-20 items-center rounded-lg'}>
      <Image
    ...
    <div className={'text-black text-right flex flex-row gap-8 m-20 items-center rounded-lg'}>
        <div className={'flex flex-col gap-10'}>
