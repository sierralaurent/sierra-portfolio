       ...
       <Scroll />
        ...
        <div className={'flex flex-col max-w-5xl p-12 gap-10 items-center m-20 mx-48'}>
            <div className={'flex flex-col items-center gap-5'}>
                ...
                <Link href="https://giphy.com/tune_zilla" rel="noopener noreferrer" target="_blank"><Button backgroundColor='Sage'>See GIPHY</Button></Link>
            </div>
        ...
        <div className={'flex flex-col items-center gap-10 m-16 mb-20 text-center'}>
            ...
            <div className={'flex flex-row gap-12 items-center'}>
                ...
                <Link href="/PicTok"><Button backgroundColor='Sage'>Next Project</Button></Link>
            </div>
      </div>
    </main>
    <Footer />
