...
export default function Home() {
  return (
    ...
    <NavBar /> 
    <main className={`flex min-h-screen flex-col items-center p-10 text-black gap-10`}>
      ...
      <div className={'flex flex-col gap-20'}>
        ...
        <div className={'flex flex-row items-center gap-10'}>
          ...
          <div>
          <Link href=""><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald'}>See All</button></Link>
          </div>
        </div>
      </div>
    </main>
