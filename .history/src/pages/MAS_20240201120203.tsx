    ...
    <main className={`flex min-h-screen flex-col items-center text-black p-48`}>
      ...
      <div className={'py-8 text-xl'}>
        ...
        <div className={'flex flx-row items-center gap-10 py-16'}>
            ...
            <Image
                className={'py-3 hover:scale-110 transition-transform h-auto'}
        ...
        <div className={'flex flex-col gap-8'}>
            ...
            <div className={'flex flex-col gap-5 py-5'}>
                    ...
                    <Image
                        className={'py-3 w-screen w-auto h-auto'}
                ...
                <div className={'flex flex-col gap-5 py-5'}>
                    ...
                    <Image
                        className={'py-3 object-cover h-auto'}
                        src='/images/MAS/MAS-BrandGuide01.png'
                        width={400}
                        height={200}
                        alt='MAS Brand Guide'
                        unoptimized={true}
                    ...
                    <Image
                        className={'py-3 object-cover h-auto'}
                        src='/images/MAS/MAS-BrandGuide02.png'
                        width={400}
                        height={200}
                        alt='MAS Brand Guide'
                        unoptimized={true}
            ...
            <div className={`flex flex-row items-center justify-between w-full py-8`}>
                ...
                <Link href="https://maloneautospa.com/"><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald'}>View Site</button></Link>
            </div>
            <div className={'flex flex-col'}>
                <p>The website still needs to be finished, as development takes time, especially when the developers have another larger website to worry about. Overall the
                    navigation is clean, the content is not overwhelming and the brand identity is consistent and attractive throughout the website and all social media.</p>
                <div className={'flex flex-row items-center justify-center py-10 tablet:flex-col'}>
                    <div className={'flex flex-row'}>
                    <Image
                        className={'p-3'}
                        src='/images/MAS/MAS-Screens/Services Page.png'
                        width={250}
                        height={150}
                        alt='Gesture Screen03'
                        unoptimized={true}
                    ...
                    <Image
                        ...
                        src='/images/MAS/MAS-Screens/Blog Page.png'
                        width={250}
                        height={100}
                        alt='Gesture Screen04'
                        unoptimized={true}
                    ...
                    <Image
                        className={'p-3 h-auto'}
                        src='/images/MAS/MAS-Screens/Member Sign-Up.png'
                        width={250}
                        height={100}
                        alt='gesture Screen05'
                        unoptimized={true}
        ...
        <div className={'flex flex-col items-center gap-10 my-28 text-center'}>
            ...
            <Link href="/hps&pigs"><button className={'bg-Sage text-white p-3 text-2xl rounded-lg hover:bg-Emerald hover:scale-110 transition-transform'}>Next Project</button></Link>
            </div>
        </div>
