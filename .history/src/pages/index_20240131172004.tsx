  ...
  return (
    ...
    <main className={`flex min-h-screen flex-col items-center text-black gap-20`}>
      ...
      <div className={'flex flex-col gap-10 items-center my-20'}>
          ...
          <h2>Let me know if you see anything you like</h2>
          <Link href="/Contact"><button className={'bg-Emerald text-white p-3 text-2xl rounded-lg hover:bg-Emerald hover:scale-110 transition-transform'}>Contact</button></Link>
        </div>
      <div className={'flex flex-col items-center gap-10 max-w-4xl'}>
      <h1 className={'text-3xl font-bold items-start self-start'}>Recent Projects</h1>
