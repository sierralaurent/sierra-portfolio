  ...
  return (
    ...
    <main className={`flex min-h-screen flex-col items-center text-black`}>
        ...
        <p className={'text-lg'}>Starting at the very beginning, the idea of PikTok, was overall too broad and too vague, starting with: 
            ...
            <Image
                className={'py-3 '}
                src='/images/PicTok/PicTok-Screens/styleguide01.png'
                width={100}
                height={100}
            ...
            <Image
                className={'py-3 '}
                src='/images/PicTok/PicTok-Screens/styleguide02.png'
                width={75}
                height={75}
                alt='Ideation of PicTok'
            />
            <Image
                className={'py-3 '}
                src='/images/PicTok/PicTok-Screens/styleguide03.png'
                width={100}
                height={100}
                alt='Ideation of PicTok'
            />
        ...
        <h2 className={'text-xl'}>Styleguide</h2>
        ...
        <PictokStyleguide />
        <h2 className={'text-xl'}>Low Fidelity Mock-Up (LoFi)</h2>
        ...
        <h2 className={'text-xl'}>High Fidelity Mock-Up (HiFi)</h2>
        ...
        <h2 className={'text-xl'}>Understanding the target audience</h2>
