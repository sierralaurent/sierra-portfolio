...
export default function PicTok() {
  ...
  return (
    ...
    <Scroll />
        ...
        <div className={'tablet:flex-col max-w-4xl tablet:max-w-sm bg-Sage text-white flex flex-row gap-4 tablet:gap-4 m-10 mx-20 items-center rounded-2xl'}>
            <Image
            ...
            />
            <div className={'flex flex-col gap-10 p-5 tablet:p-5'}>
