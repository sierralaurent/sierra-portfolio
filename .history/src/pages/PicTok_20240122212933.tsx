    ...
    <main className={`flex min-h-screen flex-col items-center text-black p-20`}>
      ...
      <div className={'py-8 text-xl'}>
        ...
        <div className={'flex flex-col gap-8'}>
            ...
            <div>
                <h1>Challenges</h1>
                <p>Designing and creating an app for use by the visually impaired community was going to be a challenge, with many barriers. Not only is there the
                ...
                <div>
                    <h1>1. Understanding the target audience</h1>
                    <h2>Resolved with a user persona</h2>
                    <Image
                        className={'py-3 w-screen'}
