...
export default function Projects() {
  return (
    ...
    <main className={`flex min-h-screen flex-col items-center p-8 text-black`}>
      ...
      <div className={'flex flex-row items-center gap-20 p-60 py-20 tablet:flex-col tablet:p-48 tablet:gap-10'}>
      <Image
          className={'py-3'}
      ...
      <div className={'flex flex-row items-center gap-20 p-60 py-20 tablet:flex-col tablet:p-48 tablet:gap-10 tablet:py-2'}>
