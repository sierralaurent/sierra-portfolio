...
export default function Home() {
  return (
    ...
    <NavBar /> 
    <Notification />
    <main className={`flex min-h-screen flex-col items-center text-black gap-10`}>
    ...
    <div className={' max-w-4xl bg-Sage text-white flex flex-row m-20 gap-8 items-center rounded-lg'}>
      <Image
